...
try:
    ...
    class TestMakoRenderer(RendererTestBase, unittest.TestCase):
        def setUp(self):
...
try:
    ...
    import jinja2
    class TestJinja2Renderer(RendererTestBase, unittest.TestCase):
        def setUp(self):
...
try:
    ...
    class TestGenshiRenderer(RendererTestBase, unittest.TestCase):
        def setUp(self):
...
try:
    ...
    class TestTempitaRenderer(RendererTestBase, unittest.TestCase):
        def setUp(self):
